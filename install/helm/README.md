...
Templates under the `templates/` directory are for the core components in Open Match - e.g. backend, frontend, queryservice, synchronizor, some security policies, and configmaps are defined under this folder.
