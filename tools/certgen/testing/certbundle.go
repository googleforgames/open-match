...
func CreateRootCertificateAndPrivateKeyForTesting(address string) ([]byte, []byte, error) {
	return certgenInternal.CreateCertificateAndPrivateKey(&certgenInternal.Params{
		ValidityDuration:     time.Hour * 1,
		Hostnames:            address,
		RSAKeyLength:         2048,
...
func CreateDerivedCertificateAndPrivateKeyForTesting(rootPublicCertificateData []byte, rootPrivateKeyData []byte, address string) ([]byte, []byte, error) {
	return certgenInternal.CreateCertificateAndPrivateKey(&certgenInternal.Params{
