...
type AssignTicketsResponse struct {
	// Failed is a list of all the Tickets that failed assignment along with the cause of failure.
	Failed               []*AssignmentFailure `protobuf:"bytes,1,rep,name=failed,proto3" json:"failed,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *AssignTicketsResponse) GetFailed() []*AssignmentFailure {
	if m != nil {
		return m.Failed
	}
	return nil
...
var fileDescriptor_8dab762378f455cd = []byte{
	...
	,
}
