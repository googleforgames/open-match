...
type Ticket struct {
	...
	// Metadata is read-only and Open Match will reject any changes to this field.
	// Metadata is a special index type that is queryable via the Mmlogic service API.
	Metadata             *Ticket_Metadata `protobuf:"bytes,4,opt,name=metadata,proto3" json:"metadata,omitempty"`
...
func (m *Ticket) GetMetadata() *Ticket_Metadata {
	if m != nil {
		return m.Metadata
	}
	return nil
...
// Metadata contains useful stats about the ticket.
type Ticket_Metadata struct {
	// Ticket creation time as a Unix time, indicates the number of seconds elapsed since Jan 1, 1970 in UTC time zone.
	CreationTimestamp    *timestamp.Timestamp `protobuf:"bytes,1,opt,name=creationTimestamp,proto3" json:"creationTimestamp,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}

func (m *Ticket_Metadata) Reset()         { *m = Ticket_Metadata{} }
func (m *Ticket_Metadata) String() string { return proto.CompactTextString(m) }
func (*Ticket_Metadata) ProtoMessage()    {}
func (*Ticket_Metadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_cb9fb1f207fd5b8c, []int{0, 0}
}

func (m *Ticket_Metadata) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Ticket_Metadata.Unmarshal(m, b)
}
func (m *Ticket_Metadata) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Ticket_Metadata.Marshal(b, m, deterministic)
}
func (m *Ticket_Metadata) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Ticket_Metadata.Merge(m, src)
}
func (m *Ticket_Metadata) XXX_Size() int {
	return xxx_messageInfo_Ticket_Metadata.Size(m)
}
func (m *Ticket_Metadata) XXX_DiscardUnknown() {
	xxx_messageInfo_Ticket_Metadata.DiscardUnknown(m)
}

var xxx_messageInfo_Ticket_Metadata proto.InternalMessageInfo

func (m *Ticket_Metadata) GetCreationTimestamp() *timestamp.Timestamp {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*Ticket_Metadata)(nil), "api.Ticket.Metadata")
...
var fileDescriptor_cb9fb1f207fd5b8c = []byte{
	...
	,
}
