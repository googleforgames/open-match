# Open Match Release Instructions

## Version Scheme

Open Match uses [Semantic Versioning 2.0.0](https://semver.org/) which is
described as a simple set of rules and requirements that dictate how version
numbers are assigned and incremented.  Under this scheme, version numbers and
...
## Full Release / Release Candidate TL;DR

1. Create a Release Issue from the release issue template.
1. Attach the issue to the milestone that it matches.
1. Complete all items in the release issue checklist below.
1. Close the release issue.

## Hot Fix Process TL;DR

1. A patch / hotfix will occur as needed, to be determined by those will commit
