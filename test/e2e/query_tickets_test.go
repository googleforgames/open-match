	...
	tests := []struct {
		...
		},
		{
			...
			gotTickets: internalTesting.GenerateFloatRangeTickets(
				internalTesting.Property{Name: e2e.FloatRangeIndex1, Min: 0, Max: 10, Interval: 2},
				internalTesting.Property{Name: e2e.FloatRangeIndex2, Min: 0, Max: 10, Interval: 2},
			),
			pool: &pb.Pool{
				FloatRangeFilters: []*pb.FloatRangeFilter{{
					Attribute: e2e.FloatRangeIndex3,
				}},
			},
			wantCode:      codes.OK,
			wantTickets:   nil,
		...
		},
		{
			...
			pool: &pb.Pool{
				FloatRangeFilters: []*pb.FloatRangeFilter{{
					Attribute: e2e.FloatRangeIndex1,
					Min:       1,
					Max:       3,
				}},
			},
			...
			wantTickets: internalTesting.GenerateFloatRangeTickets(
				internalTesting.Property{Name: e2e.FloatRangeIndex1, Min: 2, Max: 3, Interval: 2},
				internalTesting.Property{Name: e2e.FloatRangeIndex2, Min: 0, Max: 10, Interval: 2},
			),
			wantPageCount: 1,
		},
		{
			...
			wantCode: codes.OK,
			wantTickets: internalTesting.GenerateFloatRangeTickets(
				internalTesting.Property{Name: e2e.FloatRangeIndex1, Min: 2, Max: 7, Interval: 2},
				internalTesting.Property{Name: e2e.FloatRangeIndex2, Min: 0, Max: 10, Interval: 2},
			),
			wantPageCount: 2,
		},
			...
			gotTickets: []*pb.Ticket{
				{
					Properties: &structpb.Struct{
						Fields: map[string]*structpb.Value{
							e2eTesting.BoolIndex1: {Kind: &structpb.Value_BoolValue{BoolValue: true}},
						},
					},
				},
				{
					Properties: &structpb.Struct{
						Fields: map[string]*structpb.Value{
							e2eTesting.BoolIndex1: {Kind: &structpb.Value_BoolValue{BoolValue: false}},
						},
					},
				},
				{
					Properties: &structpb.Struct{
						Fields: map[string]*structpb.Value{
							e2eTesting.BoolIndex1: {Kind: &structpb.Value_StringValue{StringValue: "true"}},
						},
					},
				},
			},
			...
			gotTickets: []*pb.Ticket{
				{
					Properties: &structpb.Struct{
						Fields: map[string]*structpb.Value{
							e2eTesting.StringIndex1: {Kind: &structpb.Value_StringValue{StringValue: "true"}},
						},
					},
				},
				{
					Properties: &structpb.Struct{
						Fields: map[string]*structpb.Value{
							e2eTesting.StringIndex1: {Kind: &structpb.Value_StringValue{StringValue: "false"}},
						},
					},
				},
				{
					Properties: &structpb.Struct{
						Fields: map[string]*structpb.Value{
							e2eTesting.StringIndex1: {Kind: &structpb.Value_BoolValue{BoolValue: true}},
						},
					},
				},
			},
		...
		},
		{
			...
			gotTickets: []*pb.Ticket{
				...
				},
				{
					Properties: &structpb.Struct{
						Fields: map[string]*structpb.Value{
							e2eTesting.FloatRangeIndex1: {Kind: &structpb.Value_NumberValue{NumberValue: 100}},
						},
					},
				},
			},
