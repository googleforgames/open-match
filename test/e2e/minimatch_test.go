...
func TestMinimatch(t *testing.T) {
	...
	sourceTickets := []testTicket{
		{skill: 1, mapValue: e2e.FloatRangeIndex1, targetPool: e2e.Map1BeginnerPool},
		{skill: 5, mapValue: e2e.FloatRangeIndex1, targetPool: e2e.Map1BeginnerPool},
		{skill: 8, mapValue: e2e.FloatRangeIndex1, targetPool: e2e.Map1AdvancedPool},
		{skill: 0, mapValue: e2e.FloatRangeIndex2, targetPool: e2e.Map2BeginnerPool},
		{skill: 6, mapValue: e2e.FloatRangeIndex2, targetPool: e2e.Map2AdvancedPool},
		{skill: 10, mapValue: e2e.FloatRangeIndex2, targetPool: e2e.Map2AdvancedPool},
	...
	testPools := map[string]*pb.Pool{
		e2e.Map1BeginnerPool: {
			...
			FloatRangeFilters: []*pb.FloatRangeFilter{
				{Attribute: e2e.FloatRangeIndex3, Min: 0, Max: 5},
				{Attribute: e2e.FloatRangeIndex1, Max: math.MaxFloat64},
			},
		},
		e2e.Map1AdvancedPool: {
			Name: e2e.Map1AdvancedPool,
			FloatRangeFilters: []*pb.FloatRangeFilter{
				{Attribute: e2e.FloatRangeIndex3, Min: 6, Max: 10},
				{Attribute: e2e.FloatRangeIndex1, Max: math.MaxFloat64},
			},
		},
		e2e.Map2BeginnerPool: {
			...
			FloatRangeFilters: []*pb.FloatRangeFilter{
				{Attribute: e2e.FloatRangeIndex3, Min: 0, Max: 5},
				{Attribute: e2e.FloatRangeIndex2, Max: math.MaxFloat64},
			},
		},
				...
				for i, td := range testTickets {
					resp, err := fe.CreateTicket(ctx, &pb.CreateTicketRequest{Ticket: &pb.Ticket{
						Properties: structs.Struct{
							e2e.FloatRangeIndex3: structs.Number(td.skill),
