...
func TestGameMatchWorkFlow(t *testing.T) {
	...
	*/
	...
	var wantTickets [][]*pb.Ticket
	wantTickets = [][]*pb.Ticket{{ticket2, ticket3, ticket4}, {ticket5}}
	validateFetchMatchesResponse(t, ctx, wantTickets, be, fmReq)
...
func validateFetchMatchesResponse(t *testing.T, ctx context.Context, wantTickets [][]*pb.Ticket, be pb.BackendClient, fmReq *pb.FetchMatchesRequest) {
