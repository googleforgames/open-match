...
func TestGameMatchWorkFlow(t *testing.T) {
	...
	*/
	...
	ticket1 := &pb.Ticket{
		Properties: &structpb.Struct{
			Fields: map[string]*structpb.Value{
				e2e.FloatRangeIndex1:   {Kind: &structpb.Value_NumberValue{NumberValue: 1}},
				e2e.FloatRangeIndex2: {Kind: &structpb.Value_NumberValue{NumberValue: 1}},
			},
		},
	}
	...
	ticket2 := &pb.Ticket{
		Properties: &structpb.Struct{
			Fields: map[string]*structpb.Value{
				e2e.FloatRangeIndex1:   {Kind: &structpb.Value_NumberValue{NumberValue: 5}},
				e2e.FloatRangeIndex2: {Kind: &structpb.Value_NumberValue{NumberValue: 5}},
			},
		},
	}
	...
	ticket3 := &pb.Ticket{
		Properties: &structpb.Struct{
			Fields: map[string]*structpb.Value{
				e2e.FloatRangeIndex1:   {Kind: &structpb.Value_NumberValue{NumberValue: 10}},
				e2e.FloatRangeIndex2: {Kind: &structpb.Value_NumberValue{NumberValue: 10}},
			},
		},
	}
	...
	ticket4 := &pb.Ticket{
		Properties: &structpb.Struct{
			Fields: map[string]*structpb.Value{
				e2e.FloatRangeIndex1:   {Kind: &structpb.Value_NumberValue{NumberValue: 15}},
				e2e.FloatRangeIndex2: {Kind: &structpb.Value_NumberValue{NumberValue: 15}},
			},
		},
	}
	...
	ticket5 := &pb.Ticket{
		Properties: &structpb.Struct{
			Fields: map[string]*structpb.Value{
				e2e.FloatRangeIndex1:   {Kind: &structpb.Value_NumberValue{NumberValue: 20}},
				e2e.FloatRangeIndex2: {Kind: &structpb.Value_NumberValue{NumberValue: 20}},
			},
		},
	}
		...
		Profiles: []*pb.MatchProfile{
			{
				...
				Pools: []*pb.Pool{
					{
						Name:              "ticket12",
						FloatRangeFilters: []*pb.FloatRangeFilter{{Attribute: e2e.FloatRangeIndex1, Min: 0, Max: 6}, {Attribute: e2e.FloatRangeIndex2, Min: 0, Max: 100}},
					},
					{
						Name:              "ticket23",
						FloatRangeFilters: []*pb.FloatRangeFilter{{Attribute: e2e.FloatRangeIndex1, Min: 3, Max: 10}, {Attribute: e2e.FloatRangeIndex2, Min: 0, Max: 100}},
					},
					{
						Name:              "ticket5",
						FloatRangeFilters: []*pb.FloatRangeFilter{{Attribute: e2e.FloatRangeIndex1, Min: 0, Max: 100}, {Attribute: e2e.FloatRangeIndex2, Min: 17, Max: 25}},
					},
					{
						Name:              "ticket234",
						FloatRangeFilters: []*pb.FloatRangeFilter{{Attribute: e2e.FloatRangeIndex1, Min: 3, Max: 17}, {Attribute: e2e.FloatRangeIndex2, Min: 3, Max: 17}},
					},
				},
			},
		},
