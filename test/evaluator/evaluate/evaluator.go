...
// DoDefaultEvaluate defines the default evaluation logic for Open Match.
// This default evaluator sorts and deduplicates the input matches.
func DoDefaultEvaluate(p *evaluator.Params) ([]*pb.Match, error) {
