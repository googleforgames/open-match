...
// Config controls the type of TestContext being generated
type Config struct {
	secureMode int
}

// Init generates a random number to make sure servers generated by the helper functions have the same secure mode per test suite
func Init() *Config {
