...
func request_Synchronizer_GetContext_0(ctx context.Context, marshaler runtime.Marshaler, client SynchronizerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterSynchronizerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SynchronizerClient) error {
	...
	mux.Handle("GET", pattern_Synchronizer_GetContext_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Synchronizer_GetContext_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Synchronizer_GetContext_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
