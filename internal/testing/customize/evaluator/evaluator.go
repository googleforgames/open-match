...
func RunEvaluator(eval EvaluateFunc) {
...
func BindService(p *rpc.ServerParams, cfg config.View, evalFunc EvaluateFunc) error {
	p.AddHandleFunc(func(s *grpc.Server) {
		pb.RegisterEvaluatorServer(s, &evaluatorService{evalFunc: evalFunc})
